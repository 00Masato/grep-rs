...
const TEXT_FOR_BEFORE_CONTEXT: &'static str = "\
tests/data/test_data.txt-5-
tests/data/test_data.txt:6:How dreary to be somebody!
tests/data/test_data.txt-6-How dreary to be somebody!
tests/data/test_data.txt:7:How public, like a frog
...
const TEXT_FOR_AFTER_CONTEXT: &'static str = "\
tests/data/test_data.txt:6:How dreary to be somebody!
tests/data/test_data.txt-7-How public, like a frog
tests/data/test_data.txt:7:How public, like a frog
tests/data/test_data.txt-8-To tell your name the livelong day
...
// success
#[test]
fn success_short_before_context_test() {
    let child = Command::new("target/debug/grep-rs")
        .args(&["-B", "1", "How", "tests/data/test_data.txt"])
        .stdout(Stdio::piped())
        .spawn();
...
// success
#[test]
fn success_long_before_context_test() {
    let child = Command::new("target/debug/grep-rs")
        .args(&["--before-context", "1", "How", "tests/data/test_data.txt"])
        .stdout(Stdio::piped())
        .spawn();
